...
export default function App() {
  ...
  return(
    <div style={{minHeight:"100dvh",background:"#080e1c",color:"#fff",fontFamily:"'DM Sans',sans-serif",overflowX:"hidden",position:"relative"}}>
      ...
      <style>{`
        @keyframes glowPulse {
          0%,100% { box-shadow: 0 0 8px 0 rgba(255,180,0,0.35), 0 0 20px 0 rgba(255,180,0,0.12); }
          50% { box-shadow: 0 0 16px 3px rgba(0,229,255,0.4), 0 0 32px 4px rgba(0,229,255,0.18); }
        }
        ...
        .glow-btn { animation: glowPulse 3.2s ease-in-out infinite; }
        .glow-badge { animation: glowPulse 3.2s ease-in-out infinite, colorCycle 6s ease-in-out infinite; }
